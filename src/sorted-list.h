 ...
 * using void*.
 */
typedef struct SLItemT_* SLItemT;
typedef struct SortedListT_* SortedListT;
 ...
 */
typedef struct SortedListIterT_* SortedListIterT;
...
/* In order to streamline the destruction process, you have the option
 * of providing the SortedList with a function that destroys the data it
 * no longer needs.  
 */
